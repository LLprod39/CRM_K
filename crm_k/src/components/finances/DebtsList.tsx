...
import { AlertCircle, Phone, Calendar, ChevronRight, CheckCircle, User } from 'lucide-react'
      ...
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-500">
            Ученики с неоплаченными занятиями
          </p>
        </div>
        <div className="p-6">
        ...
        <div className="flex-1 overflow-hidden">
          <div className="divide-y divide-gray-200 h-full">
            {displayedDebts.map((debt) => (
              <div key={debt.student.id} className="p-4 flex-shrink-0">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
        ...
        {hasMoreDebts && (
          <div className="px-6 py-4 border-t border-gray-200 flex-shrink-0">
            <button
              ...
              className="w-full flex items-center justify-center px-4 py-2 text-sm font-medium text-gray-700 bg-gray-50 border border-gray-300 rounded-md hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors"
            >
              <ChevronRight className="w-4 h-4 mr-2" />
              Показать всех учеников ({debts.length})
            </button>
          </div>
        )}
      </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gradient-to-r from-red-50 to-red-100 rounded-t-2xl">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Задолженности</h3>
